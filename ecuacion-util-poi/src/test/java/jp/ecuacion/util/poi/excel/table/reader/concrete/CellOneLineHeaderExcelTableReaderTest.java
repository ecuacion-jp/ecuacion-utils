...
public class CellOneLineHeaderExcelTableReaderTest {
  ...
  public void normalTableTest() throws Exception {
    ...
    Assertions.assertEquals("data1-1", readUtil.getStringFromCell(rowList.get(0).get(0)));
    Assertions.assertEquals("data1-2", readUtil.getStringFromCell(rowList.get(0).get(1)));
    Assertions.assertEquals("data1-3", readUtil.getStringFromCell(rowList.get(0).get(2)));

    Assertions.assertEquals("data2-1", readUtil.getStringFromCell(rowList.get(1).get(0)));
    Assertions.assertEquals("data2-2", readUtil.getStringFromCell(rowList.get(1).get(1)));
    Assertions.assertEquals("data2-3", readUtil.getStringFromCell(rowList.get(1).get(2)));
  }
