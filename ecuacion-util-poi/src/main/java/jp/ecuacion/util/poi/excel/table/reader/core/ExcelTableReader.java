...
public abstract class ExcelTableReader<T> extends ExcelTable<T>
   ...
   *     
   * @param tableRowSize the row size of the table. It's equal to or greater than {@code 1}. <br>
   ...
   * @param tableColumnSize the column size of the table.
   *     It's equal to or greater than {@code 1}. <br>
   *     {@code 0} or the number smaller than that is not acceptable.<br>
